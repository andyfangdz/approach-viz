        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              '**Surface mosaic** (default off): ground composite reflectivity — the column max over every level — rasterized in Rust onto the source grid, colored in the worker with the same band tables, and draped 200 ft above field elevation as a `DataTexture` on a local-NM grid mesh (render order 70). No extra request: it rides the volume poll. Honors threshold and phase mode, ignores declutter (it is a plan view of the whole column).',
