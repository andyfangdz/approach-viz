...
- MRMS voxel coloring is phase-aware (rain/mixed/snow): server-side phase codes combine MRMS `PrecipFlag` classes with freezing-level-relative voxel altitude, and the client applies phase-specific aviation reflectivity palettes.
