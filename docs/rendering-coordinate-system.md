...
- NEXRAD Level 3 volumetric voxels use request-origin local NM offsets from a server-side multi-radar mosaic and are rendered directly in base altitude units with scene-level vertical scaling.
