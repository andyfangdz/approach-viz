...
- ADS-B traffic trails/headings are rendered from batched `lineSegments` geometries (instead of per-track line component trees), with markers in a shared instanced mesh.
