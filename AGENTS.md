...
NEXRAD volume intensity uses a conventional aviation reflectivity palette (green to magenta) with additive blending and configurable opacity for dark-scene visibility (opacity updates apply in place).
