...
fn no_store_headers_with_content_type(content_type: &'static str) -> HeaderMap {
    let mut headers = no_store_headers();
    headers.insert("content-type", HeaderValue::from_static(content_type));
    headers
}

fn traffic_binary_response(payload: TrafficBinaryPayload) -> Response {
...
fn parse_traffic_response_format(value: Option<&str>) -> TrafficResponseFormat {
    let Some(value) = value else {
